 ...
 *
 * <p>
 *     Implementations must provide the correct language plug-in for the given exercises if one exists. And call the
 *     required task for the correct language plug-in.
 *
